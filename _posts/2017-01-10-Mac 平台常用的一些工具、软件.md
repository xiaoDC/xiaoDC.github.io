...
1. [Alfred](https://www.alfredapp.com/)
   ...
   这个工具，应该是 Mac 平台下，首推的一个工具吧。随便 macOS 本身的不断升级优化，Alfred 的基本功能，已经慢慢地被 macOS 系统自带的 Spotlight 所替代。

   但是 Alfred 最为强大的应该是其 workflow。
